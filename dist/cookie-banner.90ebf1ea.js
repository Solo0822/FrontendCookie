...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/cookie-banner.js":[function(require,module,exports) {
...
// Using the crypto module to generate UUID (v4-like) for frontend
function generateUUID() {
  return crypto.randomUUID(); // This is supported in modern browsers
}
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var consentId = getCookie("consentId") || generateUUID(); // Use generateUUID to get a unique consentId
